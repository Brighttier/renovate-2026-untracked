...
exports.getMetricsHistory = exports.snapshotPlatformMetrics = exports.updateSecurityPolicies = exports.getAdminSessions = exports.terminateAdminSession = exports.createAdminSession = exports.updateAdmin = exports.inviteAdmin = exports.getAdmins = exports.checkSystemHealth = exports.getAIUsageStats = exports.logAIUsage = void 0;
 ...
 */
exports.logAIUsage = functions.https.onRequest(async (req, res) => {
 ...
 */
exports.getAIUsageStats = functions.https.onRequest(async (req, res) => {
    if (req.method === 'OPTIONS') {
        res.set(corsHeaders).status(204).send('');
        return;
    }
 ...
 */
exports.checkSystemHealth = functions.https.onRequest(async (req, res) => {
    if (req.method === 'OPTIONS') {
        res.set(corsHeaders).status(204).send('');
        return;
    }
    ...
    try {
        ...
        const admins = snapshot.docs.map(doc => {
            ...
            return ({
                ...
                lastLoginAt: (_f = (_e = (_d = doc.data().lastLoginAt) === null || _d === void 0 ? void 0 : _d.toDate) === null || _e === void 0 ? void 0 : _e.call(_d)) === null || _f === void 0 ? void 0 : _f.toISOString()
            });
        });
        res.json({ admins });
    }
 ...
 * Invite a new admin
 */
exports.inviteAdmin = functions.https.onRequest(async (req, res) => {
    if (req.method === 'OPTIONS') {
        res.set(corsHeaders).status(204).send('');
        return;
    }
 ...
 */
exports.createAdminSession = functions.https.onRequest(async (req, res) => {
    if (req.method === 'OPTIONS') {
        res.set(corsHeaders).status(204).send('');
        return;
    }
    ...
    try {
        ...
        const device = (userAgent === null || userAgent === void 0 ? void 0 : userAgent.includes('Mobile')) ? 'Mobile' :
            (userAgent === null || userAgent === void 0 ? void 0 : userAgent.includes('Tablet')) ? 'Tablet' : 'Desktop';
 ...
 */
exports.terminateAdminSession = functions.https.onRequest(async (req, res) => {
    if (req.method === 'OPTIONS') {
        res.set(corsHeaders).status(204).send('');
        return;
    }
 ...
 */
exports.getAdminSessions = functions.https.onRequest(async (req, res) => {
    if (req.method === 'OPTIONS') {
        res.set(corsHeaders).status(204).send('');
        return;
    }
    ...
    try {
        ...
        const sessions = snapshot.docs.map(doc => {
            ...
            return ({
                id: doc.id,
                ...doc.data(),
                startedAt: (_c = (_b = (_a = doc.data().startedAt) === null || _a === void 0 ? void 0 : _a.toDate) === null || _b === void 0 ? void 0 : _b.call(_a)) === null || _c === void 0 ? void 0 : _c.toISOString(),
                lastActiveAt: (_f = (_e = (_d = doc.data().lastActiveAt) === null || _d === void 0 ? void 0 : _d.toDate) === null || _e === void 0 ? void 0 : _e.call(_d)) === null || _f === void 0 ? void 0 : _f.toISOString()
            });
        });
        res.json({ sessions });
    }
 ...
 */
exports.updateSecurityPolicies = functions.https.onRequest(async (req, res) => {
    if (req.method === 'OPTIONS') {
        res.set(corsHeaders).status(204).send('');
        return;
    }
 ...
 */
exports.snapshotPlatformMetrics = functions.https.onRequest(async (req, res) => {
    if (req.method === 'OPTIONS') {
        res.set(corsHeaders).status(204).send('');
        return;
    }
    ...
    try {
        ...
        const totalRevenue = users.reduce((sum, u) => { var _a; return sum + (((_a = u.stats) === null || _a === void 0 ? void 0 : _a.totalRevenue) || 0); }, 0);
        const totalMRR = users.reduce((sum, u) => { var _a; return sum + (((_a = u.stats) === null || _a === void 0 ? void 0 : _a.monthlyRecurring) || 0); }, 0);
        const totalAICalls = users.reduce((sum, u) => { var _a; return sum + (((_a = u.stats) === null || _a === void 0 ? void 0 : _a.aiCallsThisMonth) || 0); }, 0);
 ...
 */
exports.getMetricsHistory = functions.https.onRequest(async (req, res) => {
    if (req.method === 'OPTIONS') {
        res.set(corsHeaders).status(204).send('');
        return;
    }
    ...
    try {
        ...
        const metrics = snapshot.docs.map(doc => {
            ...
            return {
                ...
                totalAICost: data.totalAICost || 0,
