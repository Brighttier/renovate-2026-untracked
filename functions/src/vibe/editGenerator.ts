...
import { EditRequest, EditResult } from './types';
...
export async function generateEdit(request: EditRequest): Promise<EditResult> {
  if (!GEMINI_API_KEY) {
...
function generateSummary(intent: any, diff: string): string {
